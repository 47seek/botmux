...
export const messages: Record<string, string> = {
  ...
  'settings.enableLocalCliOpenHelp': 'Off by default and available only when the daemon runs on macOS. Starts a separate resume process in iTerm (or Terminal), which may stop Feishu from following the session.',
