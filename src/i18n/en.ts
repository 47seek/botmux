...
export const messages: Record<string, string> = {
  ...
  'settings.sectionCollab': 'Multi-bot collaboration',
  ...
  'settings.chatBotDiscovery': 'Chat bot discovery (/members/bots)',
  'settings.chatBotDiscoveryHelp': 'Use Lark /members/bots to list bots in the current chat, so bots can reliably @-mention each other. On by default; falls back to legacy discovery when unavailable.',
