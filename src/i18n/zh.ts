...
export const messages: Record<string, string> = {
  ...
  'settings.chatBotDiscovery': '群内机器人发现（/members/bots）',
  'settings.chatBotDiscoveryHelp': '用飞书 /members/bots 列出当前群里的机器人，让机器人之间能可靠地互相 @。默认开启；接口不可用时自动回退旧的发现方式。',
