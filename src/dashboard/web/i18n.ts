...
const zh: DashboardMessages = {
  ...
  'botDefaults.sectionSummaryTrigger': '默认总结',
  'botDefaults.summaryTrigger': '开启关键词总结',
  'botDefaults.summaryTriggerHelp': '开启后，群聊或话题里命中关键词时，即使没有 @ 机器人，也会读取配置范围内的历史消息并生成总结；未命中关键词时继续完全静默。',
  'botDefaults.summaryKeyword': '关键词',
  'botDefaults.summaryKeywordPlaceholder': '例如：总结',
  'botDefaults.summaryLimit': '最近消息条数',
  'botDefaults.summarySinceHours': '最近小时数',
  'botDefaults.summaryLimitHelp': '默认读取最近 50 条 / 24 小时；任一项填 0 表示该项不做限制。话题群始终读取当前话题历史。',
  'botDefaults.summarySave': '保存总结配置',
  'botDefaults.summaryKeywordRequired': '关键词不能为空',
...
const en: DashboardMessages = {
  ...
  'botDefaults.sectionSummaryTrigger': 'Default Summary',
  'botDefaults.summaryTrigger': 'Enable keyword summary',
  'botDefaults.summaryTriggerHelp': 'When enabled, a matching keyword in a group or topic triggers this bot without an @, reads the configured history range, and generates a summary. Non-matching messages stay fully silent.',
  'botDefaults.summaryKeyword': 'Keyword',
  'botDefaults.summaryKeywordPlaceholder': 'e.g. summary',
  'botDefaults.summaryLimit': 'Recent message count',
  'botDefaults.summarySinceHours': 'Recent hours',
  'botDefaults.summaryLimitHelp': 'Default range is the latest 50 messages / 24 hours. Set either value to 0 to remove that limit. Topic groups always read the current topic history.',
  'botDefaults.summarySave': 'Save summary settings',
  'botDefaults.summaryKeywordRequired': 'Keyword is required',
